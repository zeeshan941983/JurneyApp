              ...
              ...value.images.asMap().entries.map((entry) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(width: 1.0, color: AppColors.colD6D6D6),
          ...
          Column(
            ...
            children: [
              ...
              ServicesContainer(
                ...
                subtitle: value.selections["serviceData"]!.selectedOption,
              ),
              10.h.ph,
              const Divider(),
              10.h.ph,
                ...
                children: [
                    ...
                    children: [
                      ...
                      ServicesContainer(
                        icon: value.selections['conditions'][1].icon ??
                            AppImages.wind,
                        title: value.selections['conditions'][1].conditions ??
                            'Windy',
                      ),
                    ],
                  ),
                  ...
                  CounterWidget(
                    controller: TextEditingController(
                        text: value.selections['people'].minpeople.toString()),
                  ),
                  8.h.ph,
                  AppText(
                  ...
                  CounterWidget(
                    controller: TextEditingController(
                        text: value.selections['people'].maxpeople.toString()),
                  ),
                  8.h.ph,
                  const Divider(),
                  8.h.ph,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: DiscriptionTextfield(
                          max: int.parse(value
                              .selections['priceSection'].maxDescriptionLength
                              .toString()),
                          hintText:
