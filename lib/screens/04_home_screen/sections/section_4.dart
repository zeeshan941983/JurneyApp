...
class _SpecialRegionsCalendarState extends State<SpecialRegionsCalendar> {
  ...
  void _updateSelectedDays(int day) {
    setState(() {
      ...
      calendarController.view = selectedDays.isEmpty ? CalendarView.week : CalendarView.day;
    });
  }
              ...
              List.generate(7, (index) {
                ...
                return  ElevatedButton(
                    ...
                    if (selectedDays.isNotEmpty) {
                      calendarController.displayDate = _getDateForDay(selectedDays.first);
                    }
                  },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: isSelected ? AppColors.col1E99A1 : Colors.white,
                      ...
                      text: days[index],
                      fontSize: 10.sp,
                      color: isSelected ? AppColors.colFFFFFF : AppColors.col1E99A1,
                  ),
                ).withPadding(padding:  EdgeInsets.only( left: 1.5.sp,right: 1.5.sp),);
              }),
        ...
        Container(
          ...
          child: SfCalendar(
            ...
            viewHeaderStyle: const ViewHeaderStyle(
              ...
              dateTextStyle: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w600),
              dayTextStyle: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w600),
            ),
            ...
            timeSlotViewSettings: TimeSlotViewSettings(
              ...
              numberOfDaysInView: selectedDays.isEmpty ? 7 : selectedDays.length,
              startHour: 0,
              endHour: 24,
              nonWorkingDays: selectedDays.isEmpty ? [7] : selectedDays,
            ),
            dataSource: widget.homeProvider.events,
            onTap: (calendarTapDetails) => widget.homeProvider.onCalendarTapped(calendarTapDetails, context),
            weekNumberStyle: const WeekNumberStyle(
              textStyle: TextStyle(color: AppColors.col064549, fontSize: 12, fontWeight: FontWeight.w600),
            ),
          ),
        ),
      ],
